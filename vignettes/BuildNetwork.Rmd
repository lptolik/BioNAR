...
pFit <- FitDegree( as.vector(igraph::degree(graph=sgg)),threads=1,Nsim=5,
...
```{r clusterSummary,eval=FALSE}
ggc <- calcAllClustering(gg)
```
```{r clusterSummary,eval=TRUE,include=FALSE}
ggc <- ggCluster
```
```{r clusterSummary}
